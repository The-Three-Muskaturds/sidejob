...
function AppPreviewCard({ text }: AppPreviewCardProps) {
	return (
		<>
			<div className="max-w-6xl mx-auto absolute inset-0 bg-gradient-to-t from-[#56CCF2] from-5% via-transparent via-60% to-transparent blur-3xl rounded-xl z-0"></div>
